...
<html lang="es">
    ...
    <body style="background: #FFE3B3">
        ...
        <br>
        <h1 style=" padding: 10px; background-color: #FFC172; color: black; font-family: arial,helvetica; font-size: 20px; font-weight: bold;" align="center">Bienvenido Usuario ${usuario.nombre} ${usuario.apellido}</h1>        
        <br><br>
